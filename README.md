...
This repository contains the Python code for the simulation experiments and the real data applications discussed in the paper "Provably robust learning of regression neural networks using $\beta$-divergence". The .ipynb files are well commented and self-explanatory. One can run the files Function-1-parallel.ipynb, ..., Function-5-parallel.ipynb to replicate the results in Tables 3-7 of the paper.
